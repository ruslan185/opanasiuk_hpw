...
def hangman(secret_word):
    ...
    * After each guess, you should display to the user the 
    ...
    while (a == 1):
        ...
        if any(letter not in el for el in alphabet) == True:
            if warnings != 0:
                warnings -= 1
                print(
            ...
            if letter not in letters_guessed:
                ...
                if warnings != 0:
                    warnings -= 1
                    print(
                        f'Oops! You\'ve already guessed that letter. You now have {warnings} warnings left: {get_guessed_word(secret_word, letters_guessed)}')
                else:
                    guesses -= 1
                    print(
        ...
        if get_guessed_word(secret_word, letters_guessed) == secret_word:
            return print(f'Congratulations, you won! Your total score for this game is: {guesses*len(set(secret_word))}')
        elif guesses <= 0:
            return print(f'Sorry, you ran out of guesses. The word was {secret_word}')


        if guesses != 0 or get_guessed_word(secret_word, letters_guessed) != secret_word:
            a = 1
        else:
            a = 0
'''
...
def match_with_gaps(my_word, other_word):
    ...
    if len(my_word) == len(other_word):
        for el in range(len(my_word)):
            if my_word[el] == '_':
                pass
            elif my_word[el] != other_word[el]:
                return False
        return True
    return False
...
def show_possible_matches(my_word):
    ...
    matches = [i for i in wordlist if match_with_gaps(my_word, i)]
    if not matches:
        return print('No matches found')
    else:
        return print('Possible word matches are:', ', '.join(matches))
...
def hangman_with_hints(secret_word):
    ...
    * If the guess is the symbol *, print out all words in wordlist that
    ...
    while (a == 1):
        ...
        elif any(letter not in el for el in alphabet) == True:
            if warnings != 0:
                warnings -= 1
                print(
                    f'Oops! That is not a valid letter. You have {warnings} warnings left: {get_guessed_word(secret_word, letters_guessed)}')
